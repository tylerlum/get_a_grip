...
from get_a_grip.model_training.config.nerf_evaluator_config import (
    ...
    TaskType,
    TrainingConfig,
    UnionNerfEvaluatorConfig,
)
from get_a_grip.model_training.models.nerf_evaluator import NerfEvaluator
...
def create_grid_dataset(
    input_hdf5_filepath: pathlib.Path, cfg: NerfEvaluatorConfig
) -> NerfGraspEvalDataset:
...
def main() -> None:
    # Load Config
    cfg: NerfEvaluatorConfig = tyro.cli(UnionNerfEvaluatorConfig)
    print("=" * 80)
