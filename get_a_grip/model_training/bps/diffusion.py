...
def get_bps_datasets_small_train_set(
    hdf5_path: tuple[str] | None = (
        "/scr/tylerlum/data/2024-06-06_ALBERT_BPS_Dataset/bps_data/grasp_bps_dataset_final_train.hdf5",
        "/scr/tylerlum/data/2024-06-06_ALBERT_BPS_Dataset/bps_data/grasp_bps_dataset_final_val.hdf5",
        "/scr/tylerlum/data/2024-06-06_ALBERT_BPS_Dataset/bps_data/grasp_bps_dataset_final_test.hdf5",
    ),
    use_evaluator_dataset: bool = False,
    get_all_labels: bool = False,
