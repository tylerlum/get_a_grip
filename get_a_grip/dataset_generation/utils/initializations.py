...
def initialize_convex_hull(
    ...
    **kwargs
    ...
    for i in range(n_objects):
        ...
        # Previously used faces[new_convex_hull.remove_degenerate_faces()]
        # But this is deprecated and fails for some objects because some identical vertices
        # This use of update_faces and nondegenerate_faces is equivalent
        # But also likely runs merge_vertices for us
        ...
        rotation_hand = hand_model.default_orientation.to(device)
    ...
    joint_angles_mu = hand_model.default_joint_angles.to(device)
