...
def compute_bps_evaluator_grasps(
...
def run_bps_evaluator_pipeline(
    nerf_pipeline: Pipeline,
    cfg: PipelineConfig,
    q_fr3: np.ndarray,
    q_algr: np.ndarray,
...
def main() -> None:
    ...
    qs, qds, T_trajs, success_idxs, DEBUG_TUPLE, log_dict = run_bps_evaluator_pipeline(
        nerf_pipeline=nerf_pipeline,
        cfg=args,
        q_fr3=DEFAULT_Q_FR3,
