...
from get_a_grip.grasp_motion_planning.scripts.run_pipeline import (
    CommandlineArgs,
    MultipleOutputs,
    PipelineConfig,
...
def compute_bps_sampler_grasps(
    ...
    optimized_grasp_config_dict = bps_sampler_utils.get_optimized_grasps(
    ...
    if optimize:
        ...
        if USE_NERF_EVALUATOR:
            ...
            print("=" * 80 + "\n")
            print(
                f"Loading nerf_evaluator config from {cfg.nerf_evaluator_config_path}"
            )
...
def main() -> None:
    ...
    qs, qds, T_trajs, success_idxs, DEBUG_TUPLE, log_dict = run_bps_sampler_pipeline(
        nerf_pipeline=nerf_pipeline,
        cfg=args,
        q_fr3=DEFAULT_Q_FR3,
