        ...
        for nerfdata_path in tqdm(nerfdata_paths, desc="nerfdata_paths"):
            dexdiffuser_utils.run_dexdiffuser_sim_eval(
                args=dexdiffuser_utils.CommandlineArgs(
                    ...
                    bps_evaluator_ckpt_path=pathlib.Path("/juno/u/tylerlum/github_repos/nerf_grasping/2024-06-06_ALBERT_DexEvaluator_models_5_percent/ckpt-oh6pdm0p-step-final.pth"),
                )
            )
