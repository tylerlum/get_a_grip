...
from get_a_grip.grasp_planning.utils import nerf_evaluator_utils
...
def main() -> None:
    ...
    if args.nerfdatas_path is not None:
        ...
        for nerfdata_path in tqdm(nerfdata_paths, desc="nerfdata_paths"):
            nerf_evaluator_utils.run_nerf_evaluator_sim_eval(
                args=nerf_evaluator_utils.CommandlineArgs(
